...
//        Mockito.when(propertiesConfiguration.getFileName()).thenReturn("src/test/resources/testdata/Data.xlsx");
//        Assertions.assertEquals(list,readCellExample.readCellData(li,col));
//    }
//
////    @Test
...
//        li.add(4);
//        Mockito.when(propertiesConfiguration.getFileName()).thenReturn("src/test/resources/testdata/EmptyCellData.xlsx");
//        Assertions.assertThrows(EmptyCellException.class,()->readCellExample.readCellData(li,col));
//    }
//    @Test
...
//        li.add(null);
//        Mockito.when(propertiesConfiguration.getFileName()).thenReturn("src/test/resources/testdata/Data.xlsx");
//        Assertions.assertThrows(InvalidColumnException.class,()->readCellExample.readCellData(li,col));
//    }
//}